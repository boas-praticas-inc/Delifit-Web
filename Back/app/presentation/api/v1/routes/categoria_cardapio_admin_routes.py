...
router = APIRouter(prefix="/admins/categorias-cardapio", tags=["admins-categorias-cardapio"])
...
def criar_categoria_cardapio(
    ...
    use_case: Annotated[CriarCategoriaCardapioUseCase, Depends(get_criar_categoria_cardapio_use_case)],
) -> CategoriaCardapioResponse:
...
def excluir_categoria_cardapio(
    categoria_id: int,
    use_case: Annotated[ExcluirCategoriaCardapioUseCase, Depends(get_excluir_categoria_cardapio_use_case)],
) -> None:
