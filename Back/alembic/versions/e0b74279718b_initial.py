...
def upgrade() -> None:
    ...
    op.drop_index(op.f('uq_solicitacao_em_analise_por_gestor'), table_name='solicitacoes_adesao_restaurante', postgresql_where="(status_solicitacao = 'EM_ANALISE'::status_solicitacao_adesao_enum)")
    ...
    op.add_column('usuarios', sa.Column('criado_em', sa.DateTime(), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False))
    ...
    op.drop_column('usuarios', 'ultimo_login_em')
    op.drop_column('usuarios', 'data_cadastro')
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('usuarios', sa.Column('data_cadastro', postgresql.TIMESTAMP(), server_default=sa.text('CURRENT_TIMESTAMP'), autoincrement=False, nullable=False))
    op.add_column('usuarios', sa.Column('ultimo_login_em', postgresql.TIMESTAMP(), autoincrement=False, nullable=True))
    ...
    sa.Column('cliente_id', sa.BIGINT(), autoincrement=False, nullable=False),
    sa.Column('nome_titular', sa.VARCHAR(length=150), autoincrement=False, nullable=False),
    sa.Column('ultimos_quatro_digitos', sa.CHAR(length=4), autoincrement=False, nullable=False),
    sa.Column('bandeira', sa.VARCHAR(length=30), autoincrement=False, nullable=False),
    sa.Column('token_gateway', sa.VARCHAR(length=255), autoincrement=False, nullable=True),
    ...
    sa.Column('id', sa.BIGINT(), autoincrement=True, nullable=False),
    sa.Column('pedido_id', sa.BIGINT(), autoincrement=False, nullable=False),
    sa.Column('item_cardapio_id', sa.BIGINT(), autoincrement=False, nullable=True),
    sa.Column('nome_item_snapshot', sa.VARCHAR(length=150), autoincrement=False, nullable=False),
    sa.Column('descricao_item_snapshot', sa.TEXT(), autoincrement=False, nullable=True),
    sa.Column('preco_unitario_snapshot', sa.NUMERIC(precision=10, scale=2), autoincrement=False, nullable=False),
    sa.Column('quantidade', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('observacao_item', sa.TEXT(), autoincrement=False, nullable=True),
    sa.Column('valor_total_item', sa.NUMERIC(precision=10, scale=2), autoincrement=False, nullable=False),
    ...
    sa.CheckConstraint('valor_total_item = (preco_unitario_snapshot * quantidade::numeric)', name=op.f('chk_itens_pedido_total_consistente')),
    sa.CheckConstraint('valor_total_item >= 0::numeric', name=op.f('chk_itens_pedido_valor_total')),
    sa.ForeignKeyConstraint(['item_cardapio_id'], ['itens_cardapio.id'], name=op.f('itens_pedido_item_cardapio_id_fkey'), ondelete='SET NULL'),
    ...
    sa.Column('pedido_id', sa.BIGINT(), autoincrement=False, nullable=False),
    sa.Column('cliente_id', sa.BIGINT(), autoincrement=False, nullable=False),
    sa.Column('restaurante_id', sa.BIGINT(), autoincrement=False, nullable=False),
    sa.Column('nota', sa.NUMERIC(precision=2, scale=1), autoincrement=False, nullable=False),
    ...
    sa.UniqueConstraint('pedido_id', name=op.f('avaliacoes_pedido_id_key'), postgresql_include=[], postgresql_nulls_not_distinct=False)
    )
    ...
    sa.Column('tamanho', postgresql.ENUM('PEQUENO', 'MEDIO', 'GRANDE', name='tamanho_item_enum'), autoincrement=False, nullable=True),
    sa.Column('status_item', postgresql.ENUM('ATIVO', 'INDISPONIVEL', 'INATIVO', 'ARQUIVADO', name='status_item_enum'), server_default=sa.text("'ATIVO'::status_item_enum"), autoincrement=False, nullable=False),
    sa.Column('foto_url', sa.TEXT(), autoincrement=False, nullable=True),
    sa.Column('criado_em', postgresql.TIMESTAMP(), server_default=sa.text('CURRENT_TIMESTAMP'), autoincrement=False, nullable=False),
    sa.Column('atualizado_em', postgresql.TIMESTAMP(), server_default=sa.text('CURRENT_TIMESTAMP'), autoincrement=False, nullable=False),
    ...
    op.create_table('pagamentos_mensalidade_restaurante',
    sa.Column('id', sa.BIGINT(), autoincrement=True, nullable=False),
    sa.Column('restaurante_id', sa.BIGINT(), autoincrement=False, nullable=False),
    sa.Column('valor', sa.NUMERIC(precision=10, scale=2), autoincrement=False, nullable=False),
    sa.Column('data_vencimento', postgresql.TIMESTAMP(), autoincrement=False, nullable=False),
    sa.Column('data_pagamento', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
    sa.Column('status_mensalidade', postgresql.ENUM('PENDENTE', 'PAGA', 'ATRASADA', name='status_mensalidade_restaurante_enum'), server_default=sa.text("'PENDENTE'::status_mensalidade_restaurante_enum"), autoincrement=False, nullable=False),
    sa.Column('criado_em', postgresql.TIMESTAMP(), server_default=sa.text('CURRENT_TIMESTAMP'), autoincrement=False, nullable=False),
    sa.CheckConstraint('valor >= 0::numeric', name=op.f('chk_pagamentos_mensalidade_valor')),
    sa.ForeignKeyConstraint(['restaurante_id'], ['restaurantes.id'], name=op.f('pagamentos_mensalidade_restaurante_restaurante_id_fkey'), ondelete='CASCADE'),
    ...
    sa.Column('id', sa.BIGINT(), autoincrement=True, nullable=False),
    sa.Column('pedido_id', sa.BIGINT(), autoincrement=False, nullable=False),
    sa.Column('status_chat', postgresql.ENUM('ABERTO', 'FECHADO', name='status_chat_enum'), server_default=sa.text("'ABERTO'::status_chat_enum"), autoincrement=False, nullable=False),
    sa.Column('criado_em', postgresql.TIMESTAMP(), server_default=sa.text('CURRENT_TIMESTAMP'), autoincrement=False, nullable=False),
    ...
    sa.UniqueConstraint('pedido_id', name=op.f('chats_pedido_id_key'), postgresql_include=[], postgresql_nulls_not_distinct=False)
    )
    op.create_table('restaurantes',
    sa.Column('id', sa.BIGINT(), autoincrement=True, nullable=False),
    sa.Column('gestor_id', sa.BIGINT(), autoincrement=False, nullable=False),
    sa.Column('endereco_id', sa.BIGINT(), autoincrement=False, nullable=False),
    sa.Column('solicitacao_adesao_id', sa.BIGINT(), autoincrement=False, nullable=True),
    ...
    sa.Column('cnpj', sa.CHAR(length=14), autoincrement=False, nullable=False),
    sa.Column('telefone', sa.VARCHAR(length=20), autoincrement=False, nullable=False),
    sa.Column('descricao', sa.TEXT(), autoincrement=False, nullable=True),
    sa.Column('foto_url', sa.TEXT(), autoincrement=False, nullable=True),
    sa.Column('status', postgresql.ENUM('ATIVO', 'INATIVO', 'BLOQUEADO', name='status_restaurante_enum'), server_default=sa.text("'ATIVO'::status_restaurante_enum"), autoincrement=False, nullable=False),
    sa.Column('data_cadastro', postgresql.TIMESTAMP(), server_default=sa.text('CURRENT_TIMESTAMP'), autoincrement=False, nullable=False),
    ...
    sa.ForeignKeyConstraint(['solicitacao_adesao_id'], ['solicitacoes_adesao_restaurante.id'], name=op.f('restaurantes_solicitacao_adesao_id_fkey'), ondelete='SET NULL'),
    sa.PrimaryKeyConstraint('id', name=op.f('restaurantes_pkey')),
    sa.UniqueConstraint('cnpj', name=op.f('restaurantes_cnpj_key'), postgresql_include=[], postgresql_nulls_not_distinct=False),
    sa.UniqueConstraint('endereco_id', name=op.f('restaurantes_endereco_id_key'), postgresql_include=[], postgresql_nulls_not_distinct=False),
    sa.UniqueConstraint('gestor_id', name=op.f('restaurantes_gestor_id_key'), postgresql_include=[], postgresql_nulls_not_distinct=False),
    sa.UniqueConstraint('solicitacao_adesao_id', name=op.f('restaurantes_solicitacao_adesao_id_key'), postgresql_include=[], postgresql_nulls_not_distinct=False)
    )
    op.create_index(op.f('idx_restaurantes_status'), 'restaurantes', ['status'], unique=False)
    op.create_table('solicitacoes_adesao_restaurante',
    sa.Column('id', sa.BIGINT(), autoincrement=True, nullable=False),
    sa.Column('gestor_id', sa.BIGINT(), autoincrement=False, nullable=False),
    sa.Column('nome_fantasia', sa.VARCHAR(length=150), autoincrement=False, nullable=False),
    sa.Column('razao_social', sa.VARCHAR(length=150), autoincrement=False, nullable=False),
    ...
    sa.Column('descricao', sa.TEXT(), autoincrement=False, nullable=True),
    sa.Column('foto_url', sa.TEXT(), autoincrement=False, nullable=True),
    sa.Column('cep', sa.CHAR(length=8), autoincrement=False, nullable=False),
    sa.Column('logradouro', sa.VARCHAR(length=150), autoincrement=False, nullable=False),
    ...
    sa.Column('estado', sa.CHAR(length=2), autoincrement=False, nullable=False),
    sa.Column('complemento', sa.VARCHAR(length=100), autoincrement=False, nullable=True),
    sa.Column('referencia', sa.VARCHAR(length=150), autoincrement=False, nullable=True),
    sa.Column('status_solicitacao', postgresql.ENUM('EM_ANALISE', 'APROVADO', 'REPROVADO', name='status_solicitacao_adesao_enum'), server_default=sa.text("'EM_ANALISE'::status_solicitacao_adesao_enum"), autoincrement=False, nullable=False),
    sa.Column('motivo_reprovacao', sa.TEXT(), autoincrement=False, nullable=True),
    sa.Column('criado_em', postgresql.TIMESTAMP(), server_default=sa.text('CURRENT_TIMESTAMP'), autoincrement=False, nullable=False),
    sa.Column('analisado_em', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
    sa.Column('analisado_por_admin_id', sa.BIGINT(), autoincrement=False, nullable=True),
    ...
    sa.CheckConstraint("status_solicitacao <> 'REPROVADO'::status_solicitacao_adesao_enum OR motivo_reprovacao IS NOT NULL AND length(TRIM(BOTH FROM motivo_reprovacao)) > 0", name=op.f('chk_solicitacoes_motivo_reprovacao')),
    sa.ForeignKeyConstraint(['analisado_por_admin_id'], ['admins.id'], name=op.f('solicitacoes_adesao_restaurante_analisado_por_admin_id_fkey'), ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['gestor_id'], ['gestores.id'], name=op.f('solicitacoes_adesao_restaurante_gestor_id_fkey'), ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name=op.f('solicitacoes_adesao_restaurante_pkey')),
    sa.UniqueConstraint('cnpj', name=op.f('uq_solicitacao_cnpj'), postgresql_include=[], postgresql_nulls_not_distinct=False)
    )
    op.create_index(op.f('uq_solicitacao_em_analise_por_gestor'), 'solicitacoes_adesao_restaurante', ['gestor_id'], unique=True, postgresql_where="(status_solicitacao = 'EM_ANALISE'::status_solicitacao_adesao_enum)")
    ...
    op.create_table('horarios_atendimento',
    sa.Column('id', sa.BIGINT(), autoincrement=True, nullable=False),
    sa.Column('restaurante_id', sa.BIGINT(), autoincrement=False, nullable=False),
    sa.Column('dia_semana', postgresql.ENUM('DOMINGO', 'SEGUNDA', 'TERCA', 'QUARTA', 'QUINTA', 'SEXTA', 'SABADO', name='dia_semana_enum'), autoincrement=False, nullable=False),
    sa.Column('horario_inicio', postgresql.TIME(), autoincrement=False, nullable=False),
    sa.Column('horario_fim', postgresql.TIME(), autoincrement=False, nullable=False),
    ...
    sa.ForeignKeyConstraint(['restaurante_id'], ['restaurantes.id'], name=op.f('horarios_atendimento_restaurante_id_fkey'), ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name=op.f('horarios_atendimento_pkey')),
    sa.UniqueConstraint('restaurante_id', 'dia_semana', name=op.f('uq_horario_restaurante_dia'), postgresql_include=[], postgresql_nulls_not_distinct=False)
    )
    ...
    sa.UniqueConstraint('usuario_id', name=op.f('admins_usuario_id_key'), postgresql_include=[], postgresql_nulls_not_distinct=False)
    )
    op.create_table('pagamentos_pedido',
    sa.Column('id', sa.BIGINT(), autoincrement=True, nullable=False),
    sa.Column('pedido_id', sa.BIGINT(), autoincrement=False, nullable=False),
    sa.Column('status_pagamento', postgresql.ENUM('PENDENTE', 'PAGO', 'FALHOU', 'ESTORNADO', name='status_pagamento_pedido_enum'), server_default=sa.text("'PENDENTE'::status_pagamento_pedido_enum"), autoincrement=False, nullable=False),
    sa.Column('forma_pagamento', postgresql.ENUM('PIX', 'CARTAO_CREDITO', 'CARTAO_DEBITO', 'DINHEIRO', name='forma_pagamento_enum'), autoincrement=False, nullable=False),
    sa.Column('valor', sa.NUMERIC(precision=10, scale=2), autoincrement=False, nullable=False),
    sa.Column('transacao_externa_id', sa.VARCHAR(length=255), autoincrement=False, nullable=True),
    sa.Column('pago_em', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
    sa.Column('criado_em', postgresql.TIMESTAMP(), server_default=sa.text('CURRENT_TIMESTAMP'), autoincrement=False, nullable=False),
    ...
    sa.UniqueConstraint('pedido_id', name=op.f('pagamentos_pedido_pedido_id_key'), postgresql_include=[], postgresql_nulls_not_distinct=False)
    )
    ...
    sa.Column('remetente', postgresql.ENUM('CLIENTE', 'RESTAURANTE', name='remetente_mensagem_enum'), autoincrement=False, nullable=False),
    ...
    sa.Column('usuario_id', sa.BIGINT(), autoincrement=False, nullable=False),
    sa.Column('nome_completo', sa.VARCHAR(length=150), autoincrement=False, nullable=False),
    sa.Column('cpf', sa.CHAR(length=11), autoincrement=False, nullable=False),
    sa.Column('telefone', sa.VARCHAR(length=20), autoincrement=False, nullable=False),
    ...
    sa.UniqueConstraint('cpf', name=op.f('clientes_cpf_key'), postgresql_include=[], postgresql_nulls_not_distinct=False),
    sa.UniqueConstraint('usuario_id', name=op.f('clientes_usuario_id_key'), postgresql_include=[], postgresql_nulls_not_distinct=False)
    )
    ...
    sa.Column('cliente_id', sa.BIGINT(), autoincrement=False, nullable=True),
    ...
    sa.UniqueConstraint('cpf', name=op.f('gestores_cpf_key'), postgresql_include=[], postgresql_nulls_not_distinct=False),
    sa.UniqueConstraint('usuario_id', name=op.f('gestores_usuario_id_key'), postgresql_include=[], postgresql_nulls_not_distinct=False)
    )
    op.create_table('pedidos',
    sa.Column('id', sa.BIGINT(), autoincrement=True, nullable=False),
    sa.Column('cliente_id', sa.BIGINT(), autoincrement=False, nullable=False),
    sa.Column('restaurante_id', sa.BIGINT(), autoincrement=False, nullable=False),
    sa.Column('endereco_entrega_id', sa.BIGINT(), autoincrement=False, nullable=False),
    sa.Column('status', postgresql.ENUM('PENDENTE', 'CONFIRMADO', 'EM_PREPARO', 'PRONTO', 'SAIU_PARA_ENTREGA', 'ENTREGUE', 'CANCELADO', name='status_pedido_enum'), server_default=sa.text("'PENDENTE'::status_pedido_enum"), autoincrement=False, nullable=False),
    sa.Column('forma_pagamento', postgresql.ENUM('PIX', 'CARTAO_CREDITO', 'CARTAO_DEBITO', 'DINHEIRO', name='forma_pagamento_enum'), autoincrement=False, nullable=False),
    sa.Column('observacoes', sa.TEXT(), autoincrement=False, nullable=True),
    sa.Column('valor_subtotal', sa.NUMERIC(precision=10, scale=2), autoincrement=False, nullable=False),
    sa.Column('valor_frete', sa.NUMERIC(precision=10, scale=2), server_default=sa.text('0'), autoincrement=False, nullable=False),
    sa.Column('valor_total', sa.NUMERIC(precision=10, scale=2), autoincrement=False, nullable=False),
    sa.Column('criado_em', postgresql.TIMESTAMP(), server_default=sa.text('CURRENT_TIMESTAMP'), autoincrement=False, nullable=False),
    sa.Column('confirmado_em', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
    sa.Column('entregue_em', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
